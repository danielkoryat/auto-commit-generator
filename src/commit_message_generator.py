...
gpt_model = openai_models[1]  # Set the default model to gpt-3.5-turbo
...
# Function to get the full diff for staged files and parse it using unidiff
def get_staged_diff():
...
# Function to commit changes to the repository with the provided commit message
